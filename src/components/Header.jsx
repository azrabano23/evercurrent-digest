    ...
    <header style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
        ...
        <div style={{
          ...
          <div style={{ width: '6px', height: '6px', borderRadius: '50%', background: rc, flexShrink: 0, boxShadow: `0 0 6px ${rc}80` }} />
          <select
            value={role}
          ...
          >
            {ROLES.map(r => <option key={r.id} value={r.id} style={{ background: '#13151c' }}>{r.label}</option>)}
          </select>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
        ...
        <div style={{ display: 'flex', background: '#181b24', border: '1px solid #262a38', borderRadius: '6px', padding: '3px' }}>
          {PHASES.map(p => {

      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '4px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '7px' }}>
            <div style={{ width: '7px', height: '7px', borderRadius: '50%', background: rc, boxShadow: `0 0 8px ${rc}70` }} />
            <h1 style={{ fontSize: '14px', fontWeight: 700, color: '#e8eaf0', letterSpacing: '-0.3px' }}>
              {role}
            </h1>
          </div>
          <span style={{ color: '#1f2230' }}>·</span>
          <span style={{ fontSize: '12px', color: '#50535e', fontFamily: 'ui-monospace, monospace', fontWeight: 500 }}>{phase}</span>
          {criticals > 0 && (
            <span style={{
        ...
        {groups.map(({ tier, items }) => (
          <div key={tier}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '10px' }}>
              <div style={{ width: '6px', height: '6px', borderRadius: '50%', background: TIER_COLORS[tier], boxShadow: `0 0 7px ${TIER_COLORS[tier]}80` }} />
